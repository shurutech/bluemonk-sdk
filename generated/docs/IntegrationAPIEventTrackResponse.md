...
```typescript
import type { IntegrationAPIEventTrackResponse } from 'bluemonk-sdk'
...
} satisfies IntegrationAPIEventTrackResponse
...
const exampleParsed = JSON.parse(exampleJSON) as IntegrationAPIEventTrackResponse
